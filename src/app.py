...
from astronomy.events import LunarEclipseEvent, SkyEvent
...
from sky.renderer import SkyRenderer, moon_direction, moon_screen_point
    ...
    def _draw_active_cut_in(self) -> None:
        if self.cut_in_start_frame is not None:
            ...
            if age < CUT_IN_FRAMES:
                draw_cut_in(self.cut_in_message, age, CUT_IN_FRAMES, self.cut_in_position)
            else:
